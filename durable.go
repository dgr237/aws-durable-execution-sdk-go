...
import (
	...
	"github.com/aws/durable-execution-sdk-go/client"
	durableCtx "github.com/aws/durable-execution-sdk-go/context"
...
type HandlerFunc[TEvent any, TResult any] func(event TEvent, ctx *durableCtx.DurableContext) (TResult, error)
...
func WithDurableExecution[TEvent any, TResult any](
	...
	return func(goCtx context.Context, event types.DurableExecutionInvocationInput) (types.DurableExecutionInvocationOutput, error) {
		...
		if err := durableCtx.ValidateDurableExecutionEvent(event); err != nil {
...
func runHandler[TEvent any, TResult any](
	execCtx *durableCtx.ExecutionContext,
...
func firstOperationWithInput(execCtx *durableCtx.ExecutionContext) *types.Operation {
