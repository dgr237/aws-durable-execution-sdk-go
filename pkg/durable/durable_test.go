...
func TestWithDurableExecution_SimpleStep_FirstInvocation(t *testing.T) {
	...
	handler := durable.WithDurableExecution(func(event Evt, dc types.DurableContext) (Res, error) {
...
func TestWithDurableExecution_StepReplay(t *testing.T) {
	...
	stepExecuted := false
	handler := durable.WithDurableExecution(func(event Evt, dc types.DurableContext) (Res, error) {
		raw, err := operations.Step(dc, "", func(sc types.StepContext) (any, error) {
			stepExecuted = true
...
func TestWithDurableExecution_InvalidEvent(t *testing.T) {
	handler := durable.WithDurableExecution(func(event any, dc types.DurableContext) (any, error) {
		return nil, nil
...
func TestWithDurableExecution_MultipleSteps(t *testing.T) {
	...
	handler := durable.WithDurableExecution(func(event Evt, dc types.DurableContext) (Res, error) {
		s1, err := operations.Step(dc, "step-1", func(sc types.StepContext) (any, error) {
			return "result-1", nil
		})
		if err != nil {
			return Res{}, err
		...
		s2, err := operations.Step(dc, "step-2", func(sc types.StepContext) (any, error) {
			return "result-2", nil
		})
		if err != nil {
			return Res{}, err
...
func TestWithDurableExecution_StepError(t *testing.T) {
	...
	handler := durable.WithDurableExecution(func(event Evt, dc types.DurableContext) (string, error) {
		_, err := operations.Step(dc, "failing-step", func(sc types.StepContext) (any, error) {
...
func TestWithDurableExecution_ChildContext(t *testing.T) {
	...
	handler := durable.WithDurableExecution(func(event Evt, dc types.DurableContext) (Res, error) {
		raw, err := operations.RunInChildContext(dc, "group", func(child types.DurableContext) (any, error) {
